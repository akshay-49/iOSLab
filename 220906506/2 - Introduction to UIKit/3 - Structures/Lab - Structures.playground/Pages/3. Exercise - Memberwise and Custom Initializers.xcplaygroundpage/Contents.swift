...
let favoriteBook = Book(title: "The Diary of a Wimpy Kid", author: "Jeff Kinney", pages: 300, price: 30)
...
let laptop1 = Laptop(yearPurchased: 2024)
let laptop2 = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2011)
...
let heightInCentimeters = Height(heightInCentimeters: 165.1)
