...
let akshay = User(name: "Akshay", age: 19, height: 5.9, weight: 69.0, activityLevel: 7)
print("Name: \(akshay.name), Age: \(akshay.age), Height: \(akshay.height) ft, Weight: \(akshay.weight) Kgs, Activity Level: \(akshay.activityLevel)")
...
print("Distance in meters: \(distanceInMeters.meters), Distance in feet: \(distanceInMeters.feet)")

let distanceInFeet = Distance(feet: 5249.344)
print("Distance in feet: \(distanceInFeet.feet), Distance in meters: \(distanceInFeet.meters)")
...
let anotherDistance = Distance(meters: 800)
print("Distance in meters: \(anotherDistance.meters), Distance in feet: \(anotherDistance.feet)")
/*:
