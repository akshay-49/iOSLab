...
let heartRate2 = 65
let heartRate3 = 96
let adddedHR = heartRate1 + heartRate2 + heartRate3
let averageHR = adddedHR/3
print(averageHR)
...
let heartRate1D: Double = 74
let heartRate2D: Double = 65
let heartRate3D: Double = 96
let adddedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = adddedHRD/3
print(averageHRD)
print("This result differs from the previous average as the data type is defined as double")
...
print("You've reached \(percentOfGoal)% of your goal")
