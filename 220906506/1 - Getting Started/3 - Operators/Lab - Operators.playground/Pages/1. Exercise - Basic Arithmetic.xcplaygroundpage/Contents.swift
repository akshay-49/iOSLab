...
print("Area of the yard the shed will take up \(area)")
...
let roomArea = area/2
print("The room will take up \(roomArea)")
...
print("Here we get the decimal value as we declare the type of variable as double")
...
print(even%2)
print(odd%2)
print("We can check the reminder and if the reminder is 0 then the number is even else the number is odd")
